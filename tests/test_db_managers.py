...
from flask_app.db_managers import preparing_start_end_data, get_report_from_db, get_drivers_from_db, \
    get_one_driver_from_db
...
class TestDBManagers(TestCase):
    ...
    def test_preparing_start_end_data(self, mock_func):
        ...
        assert result == [{'abbr': 'OOO', 'start_time': '12:02:58.917', 'end_time': '12:02:58.917'},
